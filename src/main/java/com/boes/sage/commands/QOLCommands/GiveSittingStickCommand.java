...
@CommandPermission("sage.givesittingstick")
public class GiveSittingStickCommand extends BaseCommand {
    ...
    public void onCommand(Player player) {
        ...
        if (meta != null) {
            ...
            meta.setLore(Collections.singletonList("§7Right click stairs, slabs, or carpets to mark them. Shift Right click on a chair to show all chairs in a radius."));
